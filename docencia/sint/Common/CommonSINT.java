...
public class CommonSINT {
	...
	public static final String PFASE = "pfase";  // nombre del parámetro que lleva la fase en todas las prácticas
    public static String PASSWD = "sp";   // la passwd de sintprof
    ...
    public static String getURLContents (String stringURL) throws ExcepcionSINT 
    {
            ...
            try {
               url = new URL(stringURL);
                ...
                throw  new ExcepcionSINT("Problema generando la URL");
            }
            ...
            try {
            	...
            	throw  new ExcepcionSINT("Problema abriendo la URL");
            }
            ...
            try {
               while ((inputLine = in.readLine()) != null) {
            	...
            	throw  new ExcepcionSINT("Problema leyendo el contenido de la URL");
            }
	...
	public static void printEndPageChecker (PrintWriter out, String previousPhase, int esProfesor, String curso) 
	{
		out.println("<form>");
		out.println("<p><input type='hidden' name='screenP' value='0'>");	
		if (esProfesor == 1) 
			out.println("<p><input type='hidden' name='p' value='si'>");	
		out.println("<input class='back' type='submit' value='Atrás' onClick='document.forms[0].screenP.value=\""+previousPhase+"\"'>");
		out.println("<input class='home'  type='submit' value='Inicio' onClick='document.forms[0].screenP.value=\"0\"'>");
		out.println("</form>");
